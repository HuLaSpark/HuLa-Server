package com.luohuo.flex.test.vo.result;
...
import com.luohuo.flex.test.enumeration.DefGenTestTreeType2Enum;
...
public class DefGenTestTreeResultVO extends TreeEntity<DefGenTestTreeResultVO, Long> implements Serializable, EchoVO {
     ...
     * 字符字典;
     *
     * @Echo(api = "com.luohuo.flex.common.api.DictApi", dictType="GLOBAL_SEX")
     */
