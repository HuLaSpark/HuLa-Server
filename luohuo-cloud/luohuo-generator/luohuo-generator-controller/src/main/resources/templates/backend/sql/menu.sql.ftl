...
-- 创建菜单
INSERT INTO def_resource(id, application_id, code, name, resource_type, parent_id, open_with, describe_, path, component, redirect, icon, is_hidden, is_general, state, sort_value, sub_group, field_is_secret, field_is_edit, data_scope, custom_class, is_def, tree_path, tree_grade, meta_json, create_by, create_time, update_by, update_time)
...
-- 创建按钮
<#if table.addShow>
INSERT INTO def_resource(id, application_id, code, name, resource_type, parent_id, open_with, describe_, path, component, redirect, icon, is_general, state, sort_value, sub_group, field_is_secret, field_is_edit, data_scope, custom_class, is_def, tree_path, tree_grade, meta_json, create_by, create_time, update_by, update_time)
...
-- 创建接口
INSERT INTO def_resource_api(id, resource_id, controller, spring_application_name, request_method, name, uri, is_input, create_by, create_time, update_by, update_time)
...
INSERT INTO def_dict(id, parent_id, parent_key, classify, key_, name, state, remark, sort_value, icon, css_style, css_class, create_by, create_time, update_by, update_time)
