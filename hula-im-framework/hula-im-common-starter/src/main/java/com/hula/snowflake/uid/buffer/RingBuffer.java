 ...
 */
package com.hula.snowflake.uid.buffer;

import com.hula.snowflake.uid.utils.PaddedAtomicLong;
...
public class RingBuffer {
    ...
    public long take() {
        ...
        Assert.isTrue(flags[nextCursorIndex].get() == CAN_TAKE_FLAG, "Curosr not in can take state");
