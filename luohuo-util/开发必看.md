...
mvn versions:set -DnewVersion="2.6.15" -DskipTests -DgenerateBackupPoms=false

mvn versions:set -DnewVersion="2.6.15-SNAPSHOT" -DskipTests -DgenerateBackupPoms=false
