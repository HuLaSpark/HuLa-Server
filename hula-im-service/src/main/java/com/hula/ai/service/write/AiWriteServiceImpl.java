...
import com.hula.ai.enums.*;
import com.hula.ai.mapper.write.AiWriteMapper;
...
import com.hula.ai.utils.DictFrameworkUtils;
...
public class AiWriteServiceImpl implements AiWriteService {
    ...
    @Override
    public Flux<ApiResult<String>> generateWriteContent(AiWriteGenerateReqVO generateReqVO, Long userId) {
