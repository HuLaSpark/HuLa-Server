...
import com.hula.ai.enums.AiChatRoleEnum;
import com.hula.ai.enums.AiModelTypeEnum;
import com.hula.ai.enums.AiPlatformEnum;
import com.hula.ai.enums.ErrorCodeConstants;
import com.hula.ai.mapper.mindmap.AiMindMapMapper;
...
public class AiMindMapServiceImpl implements AiMindMapService {
    ...
    @Override
    public Flux<ApiResult<String>> generateMindMap(AiMindMapGenerateReqVO generateReqVO, Long userId) {
