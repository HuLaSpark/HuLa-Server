package com.hula.ai.service.chat;
...
import com.hula.ai.enums.ErrorCodeConstants;
import com.hula.ai.mapper.chat.AiChatMessageMapper;
...
import static com.hula.ai.common.pojo.CommonResult.error;
import static com.hula.ai.common.pojo.CommonResult.success;
import static com.hula.ai.enums.ErrorCodeConstants.CHAT_CONVERSATION_NOT_EXISTS;
import static com.hula.ai.enums.ErrorCodeConstants.CHAT_MESSAGE_NOT_EXIST;
...
public class AiChatMessageServiceImpl implements AiChatMessageService {
    ...
    @Override
    public Flux<ApiResult<AiChatMessageSendRespVO>> sendChatMessageStream(AiChatMessageSendReqVO sendReqVO,
                                                                          Long userId) {
        // 1.1 校验对话存在
        AiChatConversationDO conversation = chatConversationService
                .validateChatConversationExists(sendReqVO.getConversationId());
