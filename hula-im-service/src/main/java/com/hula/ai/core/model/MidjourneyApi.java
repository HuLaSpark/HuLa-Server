package com.hula.ai.core.model;
...
public class MidjourneyApi {
    ...
    public SubmitResponse imagine(ImagineRequest request) {
        ...
        return JsonUtils.toObj(response, SubmitResponse.class);
    }
    ...
    public List<Notify> getTaskList(Collection<String> ids) {
        ...
        return JsonUtils.toList(res, Notify.class);
    }

    private String post(String uri, Object body) {
        return webClient.post()
                .uri(uri)
                .body(Mono.just(JsonUtils.toStr(body)), String.class)
                .retrieve()
